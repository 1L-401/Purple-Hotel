    ...
    <div class="container mx-auto px-4 py-8 max-w-3xl">
        <div class="bg-white shadow-lg rounded-lg p-6">
            ...
            <div class="flex justify-between mt-8">
                <a href="index.php?url=reservation" class="px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-blue-600 hover:bg-blue-700">
                    Back to Reservation
                </a>
                <a href="index.php?url=reservation/confirmation" class="px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-green-600 hover:bg-green-700">
                    Confirm Booking
                </a>
            </div>
        </div>
