...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['submit_reservation'])) {
    ...
    try {
        ...
        // Fix the redirect path to match your application's routing structure
        header('Location: index.php?url=reservation/billing');
        exit;
    } catch(PDOException $e) {
        // Handle database error
        $_SESSION['error'] = "Database error: " . $e->getMessage();
        // Fix the redirect path here as well
        header('Location: index.php?url=reservation/billing');
        exit;
    }
}
        ...
        <div class="bg-white shadow-lg rounded-lg p-6">
            ...
            <div id="reservation-section" class="content-section">
                ...
                <div class="profile-content space-y-8">
                    ...
                    <form action="index.php?url=reservation/submit" method="POST" class="space-y-8">
