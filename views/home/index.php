        ...
        <div class="bg-white shadow-lg rounded-lg p-6">
            ...
            <div id="home-section" class="content-section">
                ...
                <div class="profile-content space-y-8">
                    <!-- Hero Section -->
                    <div class="relative rounded-lg overflow-hidden h-64 mb-8" style="background-color: #8b5cf6;">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <a href="index.php?url=reservation" class="bg-purple-600 text-white p-6 rounded-lg hover:bg-purple-700 transition duration-300">
                            <h3 class="text-xl font-semibold mb-2">Make a Reservation</h3>
                            <p>Book your stay directly for the best rates and perks</p>
                        </a>
                        <a href="index.php?url=contact" class="bg-purple-100 text-purple-800 p-6 rounded-lg hover:bg-purple-200 transition duration-300">
